...
INSERT INTO `GARCON`.`MINIFI_NODE` (`NODE_ID`, `PRIVATE_IP`, `PUBLIC_IP`, `HOSTNAME`, `NUM_PROCESSORS`, `DEVICE_NAME`, `DEVICE_TYPE`) VALUE ('1', '192.168.1.75', '192.168.1.75', 'whiskeycellar', '4', 'WhiskeyCellar Ubuntu 16.04', 'c++');
